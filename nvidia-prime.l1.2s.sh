...
activate_intel="\"pkroot 'prime-select intel'; $this_script_path\""
activate_nvidia="\"pkroot 'prime-select nvidia'; $this_script_path\""

activate_intel_and_logout="\"pkroot 'prime-select intel'; gnome-session-quit --logout --no-prompt; $this_script_path\""
activate_nvidia_and_logout="\"pkroot 'prime-select nvidia'; gnome-session-quit --logout --no-prompt; $this_script_path\""
